...
CompConnectionData<Scalar>::CompConnectionData(std::size_t num_connection,
...
template <class Scalar>
CompConnectionData<Scalar>::CompConnectionData(const std::vector<PerforationData<Scalar>>& connections,
...
SingleCompWellState<FluidSystem>::SingleCompWellState(const std::string& well_name,
                                                      const CompositionalConfig& comp_config,
...
template <typename FluidSystem>
void
SingleCompWellState<FluidSystem>::update_injector_targets(const Well& well, const SummaryState& st)
{
...
template <typename FluidSystem>
void
SingleCompWellState<FluidSystem>::update_producer_targets(const Well& well,
...
SingleCompWellState<FluidSystem>::get_total_surface_rate() const
{
