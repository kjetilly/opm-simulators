...
// ----------------- Main program -----------------
int
flowGasWaterMain(int argc, char** argv, bool outputCout, bool outputFiles)
{
    // we always want to use the default locale, and thus spare us the trouble
    // with incorrect locale settings.
    resetLocale();

    FlowMain<Properties::TTag::FlowGasWaterProblem> mainfunc {argc, argv, outputCout, outputFiles};
    return mainfunc.execute();
}

int
flowGasWaterMainStandalone(int argc, char** argv)
{
...
flowGasWaterMainInit(int argc, char** argv, bool outputCout, bool outputFiles)
{
    ...
    return std::make_unique<FlowMain<Properties::TTag::FlowGasWaterProblem>>(argc, argv, outputCout, outputFiles);
}
