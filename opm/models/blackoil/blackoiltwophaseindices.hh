...
struct BlackOilTwoPhaseIndices
{
    ...
    static constexpr long long numSolvents = enableSolvent ? numSolventsV : 0;

    //! Number of components to be considered for extbo
    static constexpr long long numExtbos = enableExtbo ? numExtbosV : 0;

    //! Number of polymer components to be considered
    static constexpr long long numPolymers = enablePolymer ? numPolymersV : 0;

    //! Number of energy equations to be considered
    static constexpr long long numEnergy = enableEnergy ? numEnergyV : 0;

    //! Number of foam equations to be considered
    static constexpr long long numFoam = enableFoam? 1 : 0;

    //! Number of salt equations to be considered
    static constexpr long long numBrine = enableBrine? 1 : 0;

    //! The number of fluid phases
    static constexpr long long numPhases = 2;

    //! Number of MICP components to be considered
    static constexpr long long numMICPs = enableMICP ? numMICPsV : 0;

    //! The number of equations
    static constexpr long long numEq = numPhases + numSolvents + numExtbos + numPolymers +
     ...
     */
    static constexpr long long waterSwitchIdx  = waterEnabled ? PVOffset + 0 : -10000;
     ...
     */
    static constexpr long long pressureSwitchIdx  = waterEnabled ? PVOffset + 1 : PVOffset + 0;
     ...
     */
    static constexpr long long compositionSwitchIdx = (gasEnabled && oilEnabled) ? PVOffset + 1 : -10000;

    //! Index of the primary variable for the first solvent
    static constexpr long long solventSaturationIdx =
        enableSolvent ? PVOffset + numPhases : -1000;

    //! Index of the primary variable for the first extbo component
    static constexpr long long zFractionIdx =
        enableExtbo ? PVOffset + numPhases + numSolvents : -1000;

    //! Index of the primary variable for the first polymer
    static constexpr long long polymerConcentrationIdx =
