...
public:
    ...
    //!
    explicit OpmGpuILU0(const M& A, bool splitMatrix, bool tuneKernels, long long mixedPrecisionScheme);
    ...
    void LUFactorizeAndMoveData(long long moveThreadBlockSize, long long factorizationThreadBlockSize);
...
private:
    ...
    long long m_ILU0FactorizationThreadBlockSize = -1;
};
