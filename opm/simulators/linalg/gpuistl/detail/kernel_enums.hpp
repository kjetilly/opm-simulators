...
namespace Opm::gpuistl {
    ...
    namespace detail {
        bool isValidMatrixStorageMPScheme(long long scheme);
    }

    inline MatrixStorageMPScheme makeMatrixStorageMPScheme(long long scheme) {
    ...
    namespace detail {
        ...
        inline bool isValidMatrixStorageMPScheme(long long scheme) {
