...
//    FINE-GRAINED PARALLEL INCOMPLETE LU FACTORIZATION, E. Chow and A. Patel, SIAM 2015,
...
// ChowPatelIlu could also operate on a full matrix LU when L and U are merged, but it is generally better to keep them
// split
...
namespace Accelerator
{
    ...
    private:
        ...
        std::unique_ptr<cl::KernelFunctor<cl::Buffer&,
                                          cl::Buffer&,
                                          cl::Buffer&,
                                          cl::Buffer&,
                                          cl::Buffer&,
    ...
    public:
        ...
        void decomposition(cl::CommandQueue* queue,
                           cl::Context* context,
                           BlockedMatrix* LUmat,
                           BlockedMatrix* Lmat,
                           BlockedMatrix* Umat,
        ...
        void gpu_decomposition(cl::CommandQueue* queue,
                               cl::Context* context,
                               int* Ut_ptrs,
                               int* Ut_idxs,
                               double* Ut_vals,
