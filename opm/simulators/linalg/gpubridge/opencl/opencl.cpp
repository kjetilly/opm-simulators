...
namespace Accelerator
{
    ...
    std::string getErrorString(cl_int error)
    {
        ...
        case -11:
            return "CL_BUILD_PROGRAM_FAILURE, kernels in openclKernels.hpp cannot be compiled";
        case -12:
        ...
        case -9999:
            return "NVIDIA_OPENCL_ILLEGAL_READ_OR_WRITE_TO_BUFFER";

        default:
            return "UNKNOWN_CL_CODE";
        }
    }
