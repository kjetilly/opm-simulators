...
namespace Accelerator
{
    ...
    /// It is needed to prevent a compile error in basearray.hh, the nvcc compiler might not support all features in
    /// there
    class GpuResult
    {
    ...
    public:
        ...
        double conv_rate = 0.0; // average reduction of norm per iteration, usually calculated with
                                // 'static_cast<double>(pow(res.reduction,1.0/it));'
