...
void
FlowLinearSolverParameters::init(bool cprRequestedInDataFile)
{
...
FlowLinearSolverParameters::registerParameters()
{
    ...
    Parameters::Register<Parameters::LinearSolverMaxIter>("The maximum number of iterations of the linear solver");
    ...
    Parameters::Register<Parameters::LinearSolverRestart>("The number of iterations after which GMRES is restarted");
    Parameters::Register<Parameters::LinearSolverVerbosity>(
        "The verbosity level of the linear solver (0: off, 2: all)");
    Parameters::Register<Parameters::IluRelaxation>("The relaxation factor of the linear solver's ILU preconditioner");
    Parameters::Register<Parameters::IluFillinLevel>("The fill-in level of the linear solver's ILU preconditioner");
    ...
    Parameters::Register<Parameters::IluRedblack>("Use red-black partitioning for the ILU preconditioner");
    ...
    Parameters::Register<Parameters::UseGmres>("Use GMRES as the linear solver");
    ...
    Parameters::Register<Parameters::CprReuseSetup>("Reuse preconditioner setup. Valid options are "
    ...
    Parameters::Register<Parameters::GpuDeviceId>("Choose device ID for cusparseSolver or openclSolver, "
                                                  "use 'nvidia-smi' or 'clinfo' to determine valid IDs");
    Parameters::Register<Parameters::OpenclPlatformId>("Choose platform ID for openclSolver, use 'clinfo' "
                                                       "to determine valid platform IDs");
    Parameters::Register<Parameters::OpenclIluParallel>("Parallelize ILU decomposition and application on GPU");
    Parameters::Register<Parameters::LinearSolverAccelerator>("Choose the backend for the linear solver, usage: "
                                                              "'--linear-solver-accelerator=[cpu|gpu]'.");
    Parameters::Register<Parameters::GpuAwareMpi>("MPI communication use GPU aware MPI in the sense that "
