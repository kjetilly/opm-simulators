...
namespace RateConverter
{
    ...
    public:
        ...
        void defineState(const Simulator& simulator)
        {
            ...
            this->sumRates(attributes_hpv, attributes_pv, comm);
        }
        ...
        template <class Coeff>
        void calcCoeff(const int pvtRegionIdx,
                       const Scalar p,
                       const Scalar rs,
                       const Scalar rv,
                       const Scalar rsw,
        ...
        inferDissolvedVaporisedRatio(const Scalar rsMax, const Scalar rvMax, const Rates& surface_rates) const;
