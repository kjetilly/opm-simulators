...
private:
    ...
    typename std::vector<Scalar>::size_type violationValueStart(const std::size_t checkIx,
    ...
    std::pair<std::vector<std::string>, std::string::size_type> formatPointIDs(const ViolationSample& violation,
