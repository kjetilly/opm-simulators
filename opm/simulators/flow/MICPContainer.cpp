...
void
MICPContainer<Scalar>::allocate(const unsigned bufferSize)
{
...
template <class Scalar>
void
MICPContainer<Scalar>::assign(const unsigned globalDofIdx,
...
MICPContainer<Scalar>::getSolution() const
{
...
template <class Scalar>
void
MICPContainer<Scalar>::outputRestart(data::Solution& sol)
{
    if (!this->allocated_) {
        return;
    }
    ...
    std::for_each(solutionVectors.begin(), solutionVectors.end(), [&sol](auto& entry) {
...
template <class Scalar>
void
MICPContainer<Scalar>::readRestart(const unsigned globalDofIdx, const unsigned elemIdx, const data::Solution& sol)
{
    if (this->allocated_) {
        return;
    }
