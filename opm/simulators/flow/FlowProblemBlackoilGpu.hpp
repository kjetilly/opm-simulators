...
public:
    ...
    OPM_HOST_DEVICE Evaluation rockCompPoroMultiplier(const Evaluation&, std::size_t) const
    {
    ...
    template <class Evaluation>
    OPM_HOST_DEVICE Evaluation rockCompTransMultiplier(const Evaluation&, std::size_t) const
    {
        return Evaluation(0.0);
    }
    // end dummy functions.
