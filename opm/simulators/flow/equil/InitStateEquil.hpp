...
namespace EQUIL
{
    ...
    namespace Details
    {
        ...
        private:
            ...
            using GasPressODE = PhasePressODE::
                Gas<FluidSystem, typename Region::CalcEvaporation, typename Region::CalcWaterEvaporation>;
        ...
        public:
            ...
            deriveSaturations(const Position& x, const Region& reg, const PTable& ptable);
