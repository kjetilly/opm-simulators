...
namespace EQUIL
{
    ...
    namespace Miscibility
    {
        ...
        RsVD<FluidSystem>::RsVD(const int pvtRegionIdx, const std::vector<Scalar>& depth, const std::vector<Scalar>& rs)
        ...
        template <class FluidSystem>
        typename RsVD<FluidSystem>::Scalar RsVD<FluidSystem>::operator()(const Scalar depth,
                                                                         const Scalar press,
                                                                         const Scalar temp,
        ...
        template <class FluidSystem>
        typename RsVD<FluidSystem>::Scalar RsVD<FluidSystem>::satRs(const Scalar press, const Scalar temp) const
        {
        ...
        template <class FluidSystem>
        typename PBVD<FluidSystem>::Scalar PBVD<FluidSystem>::operator()(const Scalar depth,
        ...
        template <class FluidSystem>
        typename PBVD<FluidSystem>::Scalar PBVD<FluidSystem>::satRs(const Scalar press, const Scalar temp) const
        {
            return FluidSystem::oilPvt().saturatedGasDissolutionFactor(pvtRegionIdx_, temp, press);
        }
        ...
        template <class FluidSystem>
        typename PDVD<FluidSystem>::Scalar PDVD<FluidSystem>::operator()(const Scalar depth,
                                                                         const Scalar cellPress,
                                                                         const Scalar temp,
        ...
        template <class FluidSystem>
        typename PDVD<FluidSystem>::Scalar PDVD<FluidSystem>::satRv(const Scalar press, const Scalar temp) const
        {
            return FluidSystem::gasPvt().saturatedOilVaporizationFactor(pvtRegionIdx_, temp, press);
        }

        template <class FluidSystem>
        RvVD<FluidSystem>::RvVD(const int pvtRegionIdx, const std::vector<Scalar>& depth, const std::vector<Scalar>& rv)
            : pvtRegionIdx_(pvtRegionIdx)
            , rvVsDepth_(depth, rv)
        {
        }
        ...
        template <class FluidSystem>
        typename RvVD<FluidSystem>::Scalar RvVD<FluidSystem>::operator()(const Scalar depth,
                                                                         const Scalar press,
                                                                         const Scalar temp,
                                                                         const Scalar satOil) const
        {
            if (satOil < -std::sqrt(std::numeric_limits<Scalar>::epsilon())) {
                throw std::logic_error {"Must not pass negative oil saturation"};
            }
        ...
        template <class FluidSystem>
        typename RvVD<FluidSystem>::Scalar RvVD<FluidSystem>::satRv(const Scalar press, const Scalar temp) const
        {
            return FluidSystem::gasPvt().saturatedOilVaporizationFactor(pvtRegionIdx_, temp, press);
        }
        ...
        template <class FluidSystem>
        typename RvwVD<FluidSystem>::Scalar RvwVD<FluidSystem>::operator()(const Scalar depth,
                                                                           const Scalar press,
                                                                           const Scalar temp,
                                                                           const Scalar satWat) const
        {
            if (satWat < -std::sqrt(std::numeric_limits<double>::epsilon())) {
                throw std::logic_error {"Must not pass negative water saturation"};
            }
        ...
        template <class FluidSystem>
        typename RvwVD<FluidSystem>::Scalar RvwVD<FluidSystem>::satRvw(const Scalar press, const Scalar temp) const
        {
            return FluidSystem::gasPvt().saturatedWaterVaporizationFactor(pvtRegionIdx_, temp, press);
        }

        template <class FluidSystem>
        RsSatAtContact<FluidSystem>::RsSatAtContact(const int pvtRegionIdx,
        ...
        template <class FluidSystem>
        typename RsSatAtContact<FluidSystem>::Scalar RsSatAtContact<FluidSystem>::operator()(const Scalar /* depth */,
                                                                                             const Scalar press,
                                                                                             const Scalar temp,
                                                                                             const Scalar satGas) const
        {
        ...
        template <class FluidSystem>
        typename RsSatAtContact<FluidSystem>::Scalar RsSatAtContact<FluidSystem>::satRs(const Scalar press,
        ...
        template <class FluidSystem>
        RvSatAtContact<FluidSystem>::RvSatAtContact(const int pvtRegionIdx,
                                                    const Scalar pContact,
                                                    const Scalar T_contact)
            : pvtRegionIdx_(pvtRegionIdx)
        {
        ...
        template <class FluidSystem>
        typename RvSatAtContact<FluidSystem>::Scalar RvSatAtContact<FluidSystem>::operator()(const Scalar /*depth*/,
                                                                                             const Scalar press,
                                                                                             const Scalar temp,
                                                                                             const Scalar satOil) const
        {
        ...
        template <class FluidSystem>
        typename RvSatAtContact<FluidSystem>::Scalar RvSatAtContact<FluidSystem>::satRv(const Scalar press,
                                                                                        const Scalar temp) const
        {
            return FluidSystem::gasPvt().saturatedOilVaporizationFactor(pvtRegionIdx_, temp, press);
            ;
        ...
        template <class FluidSystem>
        RvwSatAtContact<FluidSystem>::RvwSatAtContact(const int pvtRegionIdx,
                                                      const Scalar pContact,
                                                      const Scalar T_contact)
            : pvtRegionIdx_(pvtRegionIdx)
        {
        ...
        template <class FluidSystem>
        typename RvwSatAtContact<FluidSystem>::Scalar RvwSatAtContact<FluidSystem>::operator()(
            const Scalar /*depth*/, const Scalar press, const Scalar temp, const Scalar satWat) const
        {
        ...
        template <class FluidSystem>
        typename RvwSatAtContact<FluidSystem>::Scalar RvwSatAtContact<FluidSystem>::satRvw(const Scalar press,
                                                                                           const Scalar temp) const
        {
            return FluidSystem::gasPvt().saturatedWaterVaporizationFactor(pvtRegionIdx_, temp, press);
            ;
    ...
    template <class Scalar>
    const typename EquilReg<Scalar>::CalcDissolution& EquilReg<Scalar>::dissolutionCalculator() const
    {
        return *this->rs_;
    }

    template <class Scalar>
    const typename EquilReg<Scalar>::CalcEvaporation& EquilReg<Scalar>::evaporationCalculator() const
    {
        return *this->rv_;
    }

    template <class Scalar>
    const typename EquilReg<Scalar>::CalcWaterEvaporation& EquilReg<Scalar>::waterEvaporationCalculator() const
    {
        return *this->rvw_;
    }

    template <class Scalar>
    const typename EquilReg<Scalar>::TabulatedFunction& EquilReg<Scalar>::saltVdTable() const
    {
        return saltVdTable_;
    }

    template <class Scalar>
    const typename EquilReg<Scalar>::TabulatedFunction& EquilReg<Scalar>::tempVdTable() const
    {
        return tempVdTable_;
    }
    ...
    PcEq<FluidSystem, MaterialLawManager>::PcEq(const MaterialLawManager& materialLawManager,
                                                const int phase,
                                                const int cell,
    ...
    PcEq<FluidSystem, MaterialLawManager>::operator()(Scalar s) const
    {
    ...
    template <class FluidSystem, class MaterialLawManager>
    PcEqSum<FluidSystem, MaterialLawManager>::PcEqSum(const MaterialLawManager& materialLawManager,
                                                      const int phase1,
                                                      const int phase2,
                                                      const int cell,
                                                      const Scalar targetPc)
    ...
    PcEqSum<FluidSystem, MaterialLawManager>::operator()(Scalar s) const
    {
        const auto& matParams = materialLawManager_.materialLawParams(cell_);
        SatOnlyFluidState fluidState;
        fluidState.setSaturation(FluidSystem::waterPhaseIdx, 0.0);
    ...
    minSaturations(const MaterialLawManager& materialLawManager, const int phase, const int cell)
    {
        const auto& scaledDrainageInfo = materialLawManager.oilWaterScaledEpsInfoDrainage(cell);
    ...
    template <class FluidSystem, class MaterialLawManager>
    typename FluidSystem::Scalar
    maxSaturations(const MaterialLawManager& materialLawManager, const int phase, const int cell)
    {
        const auto& scaledDrainageInfo = materialLawManager.oilWaterScaledEpsInfoDrainage(cell);
    ...
    template <class FluidSystem, class MaterialLawManager>
    typename FluidSystem::Scalar satFromPc(const MaterialLawManager& materialLawManager,
                                           const int phase,
                                           const int cell,
                                           ...
                                           const bool increasing)
    {
        ...
        // Find minimum and maximum saturations.
        Scalar s0 = increasing ? maxSaturations<FluidSystem>(materialLawManager, phase, cell)
                               : minSaturations<FluidSystem>(materialLawManager, phase, cell);
        Scalar s1 = increasing ? minSaturations<FluidSystem>(materialLawManager, phase, cell)
    ...
    template <class FluidSystem, class MaterialLawManager>
    typename FluidSystem::Scalar satFromSumOfPcs(const MaterialLawManager& materialLawManager,
                                                 const int phase1,
                                                 const int phase2,
                                                 const int cell,
                                                 const typename FluidSystem::Scalar targetPc)
    ...
    template <class FluidSystem, class MaterialLawManager>
    typename FluidSystem::Scalar satFromDepth(const MaterialLawManager& materialLawManager,
    ...
    {
        using Scalar = typename FluidSystem::Scalar;
        const Scalar s0 = increasing ? maxSaturations<FluidSystem>(materialLawManager, phase, cell)
                                     : minSaturations<FluidSystem>(materialLawManager, phase, cell);
        const Scalar s1 = increasing ? minSaturations<FluidSystem>(materialLawManager, phase, cell)
                                     : maxSaturations<FluidSystem>(materialLawManager, phase, cell);
