...
template <class Scalar>
void
BioeffectsSolutionContainer<Scalar>::resize(const unsigned numElems)
{
...
template <class Scalar>
bool
BioeffectsSolutionContainer<Scalar>::operator==(const BioeffectsSolutionContainer<Scalar>& rhs) const
{
