...
{
std::string
to_string(const ConvergenceReport::ReservoirFailure::Type t)
{
    ...
    assert((strPos != type_strings.end()) && "Unsupported convergence metric type");
...
std::string
to_string(const ConvergenceReport::Severity s)
{
...
std::string
to_string(const ConvergenceReport::WellFailure::Type t)
{
...
std::string
to_string(const ConvergenceReport::WellFailure& wf)
{
