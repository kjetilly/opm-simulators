...
public:
    ...
    void setNetworkNotYetBalancedForceAnotherNewtonIteration(
        const bool network_needs_more_balancing_force_another_newton_iteration)
    {
        network_needs_more_balancing_force_another_newton_iteration_
            = network_needs_more_balancing_force_another_newton_iteration;
    }
    ...
    ConvergenceReport& operator+=(const ConvergenceReport& other)
    {
        ...
        well_convergence_.insert(
            well_convergence_.end(), other.well_convergence_.begin(), other.well_convergence_.end());
    ...
    Severity severityOfWorstFailure() const
    {
        ...
        auto smax = [](Severity s1, Severity s2) { return s1 < s2 ? s2 : s1; };
