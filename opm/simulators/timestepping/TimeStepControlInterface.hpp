...
namespace Opm
{
    ...
    public:
        ...
        virtual double computeTimeStepSize( const double dt, const long long iterations, const RelativeChangeInterface& relativeChange , const double simulationTimeElapsed) const = 0;
