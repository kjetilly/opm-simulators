...
namespace Properties
{
    ...
    struct PrimaryVariables<TypeTag, TTag::FlowSimpleProblem> {
        using type = BlackOilPrimaryVariables<TypeTag, Opm::gpuistl::dense::FieldVector>;
    };
    template <class TypeTag>
...
testCreationGPUWithProblem(BlackOilFluidSystemView fs, ProblemType problem)
{
    ...
    return;
    Opm::BlackOilPrimaryVariables<TypeTagGPU, Opm::gpuistl::dense::FieldVector> primaryVariables(fs);
...
BOOST_AUTO_TEST_CASE(TestPrimaryVariablesCreationGPU)
{
    ...
    std::cout << "Opm::BlackOilPrimaryVariables<TypeNacht, Opm::gpuistl::dense::FieldVector> : "
              << typeid(Opm::BlackOilPrimaryVariables<TypeNacht, Opm::gpuistl::dense::FieldVector>).name() << std::endl;
