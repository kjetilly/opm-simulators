...
BOOST_AUTO_TEST_CASE_TEMPLATE(Empty, Scalar, Types)
{
    ...
    BOOST_CHECK_MESSAGE(!rstat.stdev().has_value(), "Standard deviation must not exist in empty sample");
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(SinglePoint, Scalar, Types)
{
    ...
    BOOST_CHECK_MESSAGE(!rstat.stdev().has_value(), "Standard deviation must not exist in single point sample");
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(Constant_Sampled_Twice, Scalar, Types)
{
    ...
    BOOST_CHECK_CLOSE(rstat.max(), samplePoint, static_cast<Scalar>(1.0e-8));
    BOOST_CHECK_CLOSE(rstat.mean(), samplePoint, static_cast<Scalar>(1.0e-8));
    BOOST_CHECK_MESSAGE(rstat.stdev().has_value(), "Standard deviation must exist in two-point sample");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(Constant_Sampled_Twice_Reset, Scalar, Types)
{
    ...
    BOOST_CHECK_MESSAGE(!rstat.stdev().has_value(), "Standard deviation must not exist in reset() sample");
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(RandN_50, Scalar, Types)
{
    ...
    for (const auto& samplePoint : {
             ...
             -5.983051973110e-01, -2.129185497807e-01, -5.160782188139e-01, -5.405962754204e-02, 1.081538561527e+00,
             -5.444361014868e-01, 6.802216201756e-01,  -1.732112159825e+00, -1.681240838370e+00, 9.026897835500e-01,
             -2.510481192847e-01, 2.503216953163e+00,  2.096538154630e+00,  -1.157169480540e+00, 2.777014458586e-01,
             3.206654292492e-01,  2.720894169117e+00,  3.394916550830e-01,  1.603500564897e+00,  1.305786976012e+00,
             3.358587787445e-01,  1.688835457016e+00,  6.464543963139e-01,  -8.880888352071e-01, 1.785948404587e+00,
             7.344602418137e-01,  1.272049108856e+00,  3.618201220834e-02,  -1.254183439007e+00, 8.551411128509e-01,
             2.002540536438e+00,  -8.442308733039e-01, -5.880385774749e-01, 5.134590162252e-01,  2.242601346140e-01,
             -1.632624091153e+00, -2.041052498197e-01, 8.535062014928e-01,  1.218406596883e-01,  4.866545018493e-01,
             -1.249277350665e+00, -5.014606488004e-01, 2.795291286626e-01,  -6.459643961814e-01, -1.061751877930e+00,
             -1.422156588627e+00, 1.026939772058e-01,  -3.551330895391e-01, 8.945851907053e-01,  -2.250951241491e-01,
         }) {
